...
class ChatClient {
  ...
  public Socket connect(String ip, int port) { 
    ...
    try {
      ...
      ObjectInputStream in = new ObjectInputStream(mySocket.getInputStream()); //Stream for network input
      ObjectOutputStream out = new ObjectOutputStream(mySocket.getOutputStream()); //Stream for network output
